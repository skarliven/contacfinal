...
(function($){
    ...
    if($("#googlemap").length > 0){
        ...
        var myOptions = {
            ...
            zoom: 15,
            center: new google.maps.LatLng(38.5815719, -121.4943996), //change the coordinates
        ...
        var marker = new google.maps.Marker({
                ...
                map: map,
                position: new google.maps.LatLng(38.5815719, -121.4943996)  //change the coordinates

        });

        var infowindow = new google.maps.InfoWindow({

                content: "<div style='color:#222'><b>Coding With Skarli</b><br/>Sacramento<br/> California</div>"  //change your address
